...
const col1Images = [
    "/assets/'We Give Up'_ Burger King flips expectations in funny new ad for the Chicken Royale.jpg",
    "/assets/35+ Creative Lettering Posters to Ignite Your Design Passion - Graphic Design Junction.jpg",
    "/assets/Creative Cosmetic Poster Design.jpg",
    "/assets/Creative advertisement - Land Rover UK.jpg",
];
const col2Images = [
    "/assets/Film Poster I Adobe Photoshop Tutorial Tutorials….jpg",
];
const col3Images = [
    "/assets/Heineken bebida.jpg",
    "/assets/Knowing these camera angles changes how you….jpg",
    "/assets/Lufthansa’s ‘green’ adverts banned in UK for misleading consumers.jpg",
    "/assets/'We Give Up'_ Burger King flips expectations in funny new ad for the Chicken Royale.jpg",
];
const col4Images = [
    "/assets/35+ Creative Lettering Posters to Ignite Your Design Passion - Graphic Design Junction.jpg",
        ...
        <div className="min-h-screen bg-[#f8f9fa] relative overflow-hidden font-sans">
            ...
            <nav className="relative z-10 flex items-center justify-between px-6 py-6 max-w-7xl mx-auto md:px-8">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-xl tracking-tight text-gray-900">FlowAI</span>
                </div>
                ...
                <div className="flex items-center gap-4 text-sm font-medium">
                    <Link href="/auth" className="text-gray-600 hover:text-gray-900 hidden md:block transition-colors">Sign in</Link>
                    <Link href="/auth?mode=signup" className="px-5 py-2.5 border border-gray-200 rounded-full hover:bg-gray-50 transition-colors bg-white shadow-sm text-gray-900">
                        Get Started
                    </Link>
                </div>
            </nav>
            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-32 md:px-8 md:pt-24 flex flex-col items-center justify-center text-center min-h-[85vh]">
                ...
                <motion.div
                    ...
                    className="mt-10"
                >
                    <Link href="/auth?mode=signup" className="px-8 py-4 bg-blue-600 text-white rounded-full font-medium text-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/25 flex items-center gap-2">
                ...
                {}
                <motion.div
                    initial={{ x: -320, y: -20, opacity: 0, rotate: -5 }}
                    animate={{ x: -220, y: 0, opacity: 1, rotate: -6 }}
                ...
                >
                    ...
                    <p className="font-sans text-xl md:text-2xl text-gray-800 leading-tight">
                ...
                {}
                <motion.div
                    initial={{ x: 350, y: -20, opacity: 0, rotate: 5 }}
                    animate={{ x: 250, y: 0, opacity: 1, rotate: 4 }}
                ...
                {}
                <motion.div
                    initial={{ x: -250, y: 20, opacity: 0, rotate: -2 }}
                    animate={{ x: -200, y: 10, opacity: 1, rotate: -3 }}
                ...
                {}
                <motion.div
                    initial={{ x: 250, y: 20, opacity: 0, rotate: 3 }}
                    animate={{ x: 200, y: 0, opacity: 1, rotate: 5 }}
            ...
            <section className="relative w-full h-[700px] md:h-[900px] bg-[#f8f9fa] overflow-hidden flex items-center justify-center">
                ...
                {}
                <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-[65%] md:-translate-x-[45%] w-[600px] h-[600px] md:w-[900px] md:h-[900px] rounded-full animate-spin-slow pointer-events-none">
                    <OrbitNode url={col1Images[0]} angle={0} radius={380} size={280} />
                    <OrbitNode url={col1Images[1]} angle={72} radius={320} size={240} blur />
                    <OrbitNode url={col1Images[2]} angle={144} radius={420} size={280} />
                    <OrbitNode url={col1Images[3]} angle={216} radius={340} size={250} blur />
                    <OrbitNode url={col2Images[0]} angle={288} radius={400} size={270} />
                </div>

                {}
                <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-[65%] md:translate-x-[45%] w-[600px] h-[600px] md:w-[900px] md:h-[900px] rounded-full animate-spin-slow-reverse pointer-events-none">
                    <OrbitNode url={col3Images[0]} angle={36} radius={380} size={280} reverseContainer />
                    <OrbitNode url={col3Images[1]} angle={108} radius={320} size={240} blur reverseContainer />
                    <OrbitNode url={col3Images[2]} angle={180} radius={420} size={280} reverseContainer />
                    <OrbitNode url={col3Images[3]} angle={252} radius={340} size={250} blur reverseContainer />
                    <OrbitNode url={col4Images[0]} angle={324} radius={400} size={270} reverseContainer />
                </div>
            ...
            <footer className="px-6 md:px-8 pb-8 bg-white">
                <div className="max-w-7xl mx-auto bg-white rounded-[40px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden relative pt-16 md:pt-24 px-8 md:px-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 relative z-10 mb-32 md:mb-48">
                        ...
                        <div className="lg:col-span-4">
                            <p className="text-xl font-medium text-gray-900 leading-snug max-w-sm">
                                FlowAI is the AI ad generation platform that builds high-converting creatives—all in one place.
                            </p>
                        </div>
                    ...
                    <div className="absolute bottom-0 left-0 w-full translate-y-1/3 flex justify-center pointer-events-none">
                        <h1 className="text-[22vw] font-bold text-blue-500/60 blur-md select-none tracking-tighter leading-none">
                            FlowAI
                        </h1>
                    </div>
                </div>
